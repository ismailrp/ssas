...
const groups = [
  { title: "Evidence dan klasifikasi klaim", terms: [
    ["OBSERVED", "Fakta yang terlihat langsung dari evidence dan dapat ditelusuri ke file sumber."],
    ["INFERRED", "Indikasi kuat dari gabungan evidence, tetapi dampaknya belum diukur secara langsung."],
    ...
    ["Evidence gap", "Data yang belum tersedia. Kondisi ini bukan bukti adanya masalah performa."],
  ]},
  { title: "Storage dan model", terms: [
    ["USED_SIZE", "Ukuran dari DMV untuk membandingkan storage secara relatif; bukan ukuran resmi total resident memory."],
  ...
  { title: "Runtime dan tuning", terms: [
  ...
  { title: "Prioritas dan keputusan", terms: [
    ["P0", "CRITICAL — score 80–100. Batas ini berlaku pada scorecard Tabular maupun Multidimensional dan menunjukkan urutan investigasi tertinggi, bukan bukti insiden atau latency kritis."],
    ["P1", "HIGH — score 60–79. Batas ini berlaku pada scorecard Tabular maupun Multidimensional dan menunjukkan prioritas investigasi tinggi."],
    ["P2", "MEDIUM — score 30–59. Batas ini berlaku pada scorecard Tabular maupun Multidimensional dan menunjukkan prioritas investigasi menengah."],
    ["P3", "LOW — score 0–29. Batas ini berlaku pada scorecard Tabular maupun Multidimensional dan menunjukkan prioritas relatif rendah; bukan pernyataan bahwa model sehat."],
    ["Score Tabular", "Score relatif terhadap fleet Tabular dari complexity 22,22%, storage 27,78%, partition 16,67%, relationship 16,67%, dan static DAX 16,67%."],
    ["Score Multidimensional", "Score relatif terhadap fleet Multidimensional dari structural, partition, relationship/dimension usage, aggregation, dan calculation. Kategori tanpa evidence dikeluarkan dan bobot kategori yang tersedia dinormalisasi."],
    ["Perbandingan score", "Rentang P0–P3 sama, tetapi score Tabular dan Multidimensional tidak dapat dibandingkan langsung karena objek, evidence, kategori, dan populasi pembandingnya berbeda."],
    ...
    ["Analisis lanjutan", "Pemeriksaan terarah pada model prioritas menggunakan query nyata dan evidence tambahan."],
  ]},
];
...
export default function GlossaryPage() {
  return <main className="min-h-screen bg-[#f6f8f5] text-[#17241f]">
    ...
    <header className="bg-gradient-to-br from-[#123d37] to-[#187064] px-5 py-16 text-white sm:px-8 lg:py-24">
      <div className="mx-auto max-w-7xl"><p className="text-xs font-extrabold uppercase tracking-[.2em] text-[#9ed1c7]">Referensi</p><h1 className="mt-4 max-w-4xl font-[family-name:var(--font-display)] text-5xl font-extrabold tracking-[-.05em] sm:text-7xl">Glosarium assessment SSAS</h1><p className="mt-6 max-w-2xl text-base leading-7 text-[#cce1dc]">Definisi singkat agar evidence, score, temuan, dan rencana validasi dibaca secara konsisten.</p></div>
    </header>
